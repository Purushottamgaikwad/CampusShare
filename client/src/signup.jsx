        ...
        <div className='signup'>
            <div className="signup-content">
                <form onSubmit={handleSubmit}>
                    ...
                    <select name="collegeName" className="select" onChange={handleChange}>
                    ...
                    <input type="number" name="currentYear" placeholder="Enter your Current year" onChange={handleChange} required />
                    <input type="email" name="email" placeholder="Enter Your Email" onChange={handleChange} required />
                    <div className="password-field">
                        <input type={showPassword ? "text" : "password"} name="password" placeholder="Set password" onChange={handleChange} required />
                        <span
                            className="eye"
