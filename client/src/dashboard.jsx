...
function Dashboard() {
  ...
  const {openChatWith, isChatOpen,setIsChatOpen} = useChat();
...
useEffect(() => {
  if (userProfile?.user?.id) {
    // console.log('🟢 registering socket:', userProfile.user.id);
    socket.emit('register', userProfile.user.id);
  }
}, [userProfile?.user?.id]);
...
//   console.log('userProfile.user.id:', userProfile?.user?.id);
// }, [userProfile]);
    ...
    <>
      ...
      <div className="dashboard">
        ...
        <div className="sorter">
          ...
          <select name="location" id="college-filter" onChange={(e) => setLocation(e.target.value)}>
            ...
            <option value="Avasari Khurd">Avasari Khurd</option>
            ...
            <option value="Betegaon">Betegaon</option>
            ...
            <option value="Darapur">Darapur</option>
            ...
            <option value="Kashti">Kashti</option>
            <option value="Katraj">Katraj</option>
            <option value="Kegaon">Kegaon</option>
            <option value="Khalapur">Khalapur</option>
            <option value="Kharghar">Kharghar</option>
            <option value="Khed">Khed</option>
            <option value="Khopi">Khopi</option>
            ...
            <option value="Lakhewadi">Lakhewadi</option>
            ...
            <option value="Sudumbare">Sudumbare</option>
            ...
            <option value="Vangali">Vangali</option>
            <option value="Varale">Varale</option>
            <option value="Varye">Varye</option>
        ...
        <div className="dashboard-post-container">
            ...
            postData.map(post => (
              <div key={post.post_id} className={`dashboard-post-card ${post.isInactive ? "inactive" : ""}`}>
                ...
                <div className="action-btns">
                  <button className="action-btn secondary" onClick={() => handleMessage(post)}>Message</button>
          ...
          {isChatOpen &&(  
            ...
            <ChatPage  currentUser={userProfile.user} />
